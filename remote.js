...
g.Xc(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Ab(a)},jBa=function(a,b){var c=g.Bd("SCRIPT");
...
g.Yc(c,g.ae("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},kBa=function(){var a=iBa(),b=window.document.getElementById(a),c=b&&g.dF(b,"loaded");
...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;mBa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",u6,c)}},pBa=function(){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
...
a.qd&&(c=null);var d=(0,g.z)(a.tU,a);c||(c=new g.zm("//www.google.com/images/cleardot.gif"),c6(c));zBa(c.toString(),1E4,d)}else E6(2);QBa(a,b)},QBa=function(a,b){a.g=0;
...
g.SG({YTP_MDX_CAST_SELECTOR:"Casten...",YTP_MDX_MY_COMPUTER:"Deze computer",YTP_MDX_PLAYER_ERROR:"Deze video kan niet op afstand worden afgespeeld.",YTP_MDX_STATUS_CONNECTED_2:"Verbonden met $RECEIVER_NAME",YTP_MDX_STATUS_ERROR_2:"Fout op $RECEIVER_NAME",YTP_MDX_STATUS_PLAYING_2:"Wordt afgespeeld op $RECEIVER_NAME",YTP_MDX_TITLE:"Afspelen op"});this.o={key:j6(),name:g.V("YTP_MDX_MY_COMPUTER")};this.B=null;this.C=[];this.I=this.l=null;this.F=[this.o];this.A=this.o;this.D=new g.XO(64);this.H=0;if(!g.CM(g.Y(this.g))){a=
this.g;var b=g.iI(a);b&&(b=b.vo())&&(b=new G8(a,b),g.M(this,b));b=new F8(a);g.M(this,b);g.nV(a,b.element,4)}},gDa=function(a,b,c){a.D=c;
